    ...
    try {
      ...
      if (user?.id) {
        ...
        if (existingProfile && existingProfile.number) {
          ...
          let randomNumber = Math.floor(Math.random() * (999999 - 1000 + 1)) + 1000;
      ...
      toast({
        title: "Error",
        description: "Failed to fetch shopping lists or update user profile",
        variant: "destructive",
      });
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-accent/20">
      <div className="container max-w-4xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          {userNumber !== null && <span className="text-sm text-muted-foreground">User Number: {userNumber}</span>}
